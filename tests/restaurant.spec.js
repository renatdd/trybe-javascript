...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    let testObject = { food: {}, drink: {} },
    result = createMenu(testObject),
    expected = { fetchMenu: testObject };
    ...
    // ```
    const menuKeys = Object.keys(result.fetchMenu);
    ...
    // ```
    assert.deepStrictEqual(result.fetchMenu, testObject);
    ...
    // ```
    testObject = { food: {'coxinha': 3.9, 'sopa': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9} };
    result = createMenu(testObject);
    ...
    result.order('agua');
    result.order('coxinha');
    assert.deepStrictEqual(result.consumption, ['coxinha', 'agua', 'coxinha']);
    ...
    // ```
    assert.strictEqual(result.pay(), 3 * 3.9);
